...
function updateConfidenceBar(confidence) {
    ...
    // Change color based on confidence level (dark monochrome)
    if (pct >= 70) {
        bar.style.background = 'linear-gradient(90deg, #ccc, #fff)';
    } else if (pct >= 40) {
        bar.style.background = 'linear-gradient(90deg, #777, #aaa)';
    } else {
